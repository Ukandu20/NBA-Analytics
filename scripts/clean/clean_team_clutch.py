#!/usr/bin/env python3
"""
clean_team_clutch.py
====================

Clean the raw CSVs downloaded by `scrape_team_clutch.py`.

Input tree (per season)
-----------------------
data/raw/team_stats/clutch/<season>/
└─ totals/
...
Output tree (same shape, but under *processed*)
-----------------------------------------------
data/processed/team_stats/clutch/<season>/
└─ totals/
   ├─ regular_season_traditional.csv
   ⋮
└─ per_game/
...
3. Parse `season` (YYYY-YY) to numeric `season_start`, `season_end`.
...
*No per-team splits are created.*
...
RAW_ROOT  = ROOT / "data/raw/team_stats/clutch"
PROC_ROOT = ROOT / "data/processed/team_stats/clutch"
...
def parse_cli() -> argparse.Namespace:
    ap = argparse.ArgumentParser(
        ...
        description="Clean NBA team clutch tables.",
    )
