#!/usr/bin/env python3
"""
clean_team_shot_dashboard.py
============================

Clean the raw CSVs saved by `scrape_team_shot_dashboard.py`
(Teams ➤ Shot Dashboard).

Raw layout (per season)
-----------------------
data/raw/team_stats/shot_dashboard/<season>/
└─ totals/
...
Output layout (identical shape, but under *processed*)
------------------------------------------------------
data/processed/team_stats/shot_dashboard/<season>/
└─ totals/
...
3. Parse `season` (YYYY-YY) → numeric `season_start`, `season_end`
...
RAW_ROOT  = ROOT / "data/raw/team_stats/shot_dashboard"
PROC_ROOT = ROOT / "data/processed/team_stats/shot_dashboard"
...
def parse_cli() -> argparse.Namespace:
    ap = argparse.ArgumentParser(
        ...
        description="Clean NBA team shot-dashboard tables.",
    )
