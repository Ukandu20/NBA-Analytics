#!/usr/bin/env python3
"""
clean_player_defense_dashboard.py
=======================

Clean the raw ‘player defense_dashboard’ tables (totals / per_game / per48) and
...
RAW_ROOT  = ROOT / "data/raw/player_stats/defense_dashboard"
PROC_ROOT = ROOT / "data/processed/player_stats/defense_dashboard"
...
def _parse_cli() -> argparse.Namespace:
    ap = argparse.ArgumentParser(
        ...
        description="Clean player defense_dashboard tables & build per-team splits.",
    )
