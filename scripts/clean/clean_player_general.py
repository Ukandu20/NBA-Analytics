#!/usr/bin/env python3
"""
clean_player_general.py
=======================

Clean the raw ‘player general’ tables (totals / per_game / per48) and
...
RAW_ROOT  = ROOT / "data/raw/player_stats/general"
PROC_ROOT = ROOT / "data/processed/player_stats/general"
...
def _parse_cli() -> argparse.Namespace:
    ap = argparse.ArgumentParser(
        ...
        description="Clean player general tables & build per-team splits.",
    )
