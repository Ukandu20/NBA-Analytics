...
DATA_ROOT = pathlib.Path("data/raw/player_stats/shot_dashboard")

# map category keys → API PtMeasureType values
CAT_MAP = {
    "general":            "General",
    "shotclock":          "ShotClock",
    "dribbles":           "Dribble",
...
# only the "general" category has sub-ranges
GENERAL_RANGE = {
    "overall":     "Overall",
...
def fetch_combo(season: str,
    ...
    # populate all parameters, blanking out optional filters
    params = {
        "Season":             season,
    ...
    for season in seasons:
        for season_type in SEASON_TYPES:
            for per_mode in PER_MODES:
                ...
                # 2) each other category, no sub-range
